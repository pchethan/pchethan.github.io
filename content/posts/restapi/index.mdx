...
While designing APIs, there are always cases where neither the thesis not the his blog help. Then, its best to make a choice that does not violate the 6 styles or loose any pros induced by them. Ultimetely, "...lities" are the ones that matter.
